...
public:
	...
	int get_allocation_size() { return allocation_size; }
	bool get_palettized() { return palettized; }
	...
	// copy the specified portion of the image into a new BitmapData object
	void copy_rect(BitmapData& copy, int x, int y, int w, int h);
